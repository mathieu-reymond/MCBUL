...
class StorageVector {
    ...
    public:
         ...
         *
         * @param other The StorageVector to copy.
         */
        StorageVector(const StorageVector & other);
         ...
         */
        StorageVector & operator=(const StorageVector & other);
...
class StorageMatrix2D {
    ...
    public:
         ...
         * @brief Copy constructor.
         *
         * @param other The StorageMatrix2D to copy.
         */
        StorageMatrix2D(const StorageMatrix2D & other);
         ...
         * @return A reference to *this after assignment.
         */
        StorageMatrix2D & operator=(const StorageMatrix2D & other);
